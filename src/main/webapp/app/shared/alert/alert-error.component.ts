...
export class JhiAlertErrorComponent implements OnDestroy {
  ...
  constructor(private alertService: JhiAlertService, private eventManager: JhiEventManager, private translateService: TranslateService) {
    ...
    this.cleanHttpErrorListener = eventManager.subscribe('estoqueinteligenteApp.httpError', response => {
      let i;
        ...
        case 400:
          ...
          if (errorHeader) {
            ...
            for (i = 0; i < fieldErrors.length; i++) {
              ...
              const fieldName = translateService.instant('estoqueinteligenteApp.' + fieldError.objectName + '.' + convertedField);
